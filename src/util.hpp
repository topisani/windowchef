...
struct double_iterator {
  ...
  using value_type =
    std::decay_t<decltype(*std::declval<typename wrapped::value_type>())>;
...
struct nomove_vector {
  ...
  using const_iterator =
    double_iterator<typename decltype(_order)::const_iterator>;

  using reverse_iterator =
    double_iterator<typename decltype(_order)::reverse_iterator>;
